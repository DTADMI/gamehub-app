...
// Note: Recharts passes a custom set of props to content renderers that isn't
// easily expressed via the exported types. Use a permissive type here to keep
// app build green across minor Recharts typings changes.
